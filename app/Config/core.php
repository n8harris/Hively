 ...
 */
	...
	// TEST
//	Configure::write('ooyala.api_key', 'dtM2MxOtvvSySgF6KGxB2ax1sHlU.a1Sqf');
//	Configure::write('ooyala.secret_key', 'lOhCtET3P9Quq9AYoGdtv9pAOI5Z6moujSFnVv7m');
 ...
 */
	...
	Configure::write('Session.cookieTimeout', $_ENV['COOKIE_SESSION_TIMEOUT'] );
...
Cache::config('mem_request', array(
	'engine' => 'Memcached',
	'duration' => '+4 hours'
));
